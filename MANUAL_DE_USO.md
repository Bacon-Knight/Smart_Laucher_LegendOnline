...
### C. Formação Mágica Inteligente (Modo Tático 24.000 Pts)
1. Ative a **Formação Mágica** diretamente pelo menu `🛠` ou pelo painel de macros (sem necessidade de tecla de atalho).
2. O bot assume o controle tático do tabuleiro 5x5:
   - **Passo 1:** Elimina os 8 alvos iniciais (quinas e meios das bordas).
   - **Passo 2:** Elimina os 8 alvos do anel interno verde.
   - **Trava de Segurança & Buffs:** Confirma a eliminação dos 16 monstros e ativa o **Globo Verde 💚** (+50% pontos) e **Globo Azul 💙** (+400 pts).
   - **Passo 3:** Ataca o monstro do centro (relação em asterisco *) para limpar 17 quadros de uma vez e pontuar **6.030 pontos**.
3. **Totalmente Inteligente e em Segundo Plano**: Monitora cada combate via `CombatDetector` aguardando a luta terminar antes do próximo clique. Repete o ciclo automaticamente até atingir os **24.000 pontos**.
